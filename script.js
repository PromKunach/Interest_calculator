...
หมายเหตุ: สามารถเปิดได้คนละ 1 บัญชีเท่านั้น หากอายุเกิน 15 ปีบริบูรณ์แล้ว สามารถเปิดบัญชีเงินฝากออมทรัพย์แบบปกติ`],
    ...
    "ไทยพาณิชย์": ["หมายเหตุ: กรุณาเปรียบเทียบข้อมูล กับธนาคารเพื่อการเกษตรและ สหกรณ์การเกษตรอีกครั้ง เนื่องจาก เป็นธนาคารรูปแบบพิเศษ"],
...
ฝากเป็นประจำทุกเดือนในจำนวนที่เท่ากันตามที่ได้ตกลงไว้กับธนาคาร โดยนำฝากเงินประจำเดือนไม่เกินวันสุดท้ายของเดือนนั้นๆ`],
    ...
    "กรุงศรีอยุธยา": ["หมายเหตุ: กรุณาเปรียบเทียบข้อมูล กับธนาคารเพื่อการเกษตรและ สหกรณ์การเกษตรอีกครั้ง เนื่องจาก เป็นธนาคารรูปแบบพิเศษ"],
...
ได้รับยกเว้นภาษีดอกเบี้ยเงินฝาก ตามข้อกำหนดของกรมสรรพากร`],
    ...
    "ทหารไทยธนชาต": ["หมายเหตุ: กรุณาเปรียบเทียบข้อมูล กับธนาคารเพื่อการเกษตรและ สหกรณ์การเกษตรอีกครั้ง เนื่องจาก เป็นธนาคารรูปแบบพิเศษ"],
...
บัญชีร่วมของบุตรผู้เยาว์กับบิดาหรือมารดา / สามี-ภรรยา`],
    "ยูโอบี": ["หมายเหตุ: กรุณาเปรียบเทียบข้อมูล กับธนาคารเพื่อการเกษตรและ สหกรณ์การเกษตรอีกครั้ง เนื่องจาก เป็นธนาคารรูปแบบพิเศษ"],
    "ซีไอเอ็มบี ไทย": ["หมายเหตุ: กรุณาเปรียบเทียบข้อมูล กับธนาคารเพื่อการเกษตรและ สหกรณ์การเกษตรอีกครั้ง เนื่องจาก เป็นธนาคารรูปแบบพิเศษ"],
    "เกียรตินาคินภัทร": ["หมายเหตุ: กรุณาเปรียบเทียบข้อมูล กับธนาคารเพื่อการเกษตรและ สหกรณ์การเกษตรอีกครั้ง เนื่องจาก เป็นธนาคารรูปแบบพิเศษ"],
    "แลนด์ แอนด์ เฮ้าส์ ": ["หมายเหตุ: กรุณาเปรียบเทียบข้อมูล กับธนาคารเพื่อการเกษตรและ สหกรณ์การเกษตรอีกครั้ง เนื่องจาก เป็นธนาคารรูปแบบพิเศษ"]
};
...
function expand(){
    ...
    console.log(maindiv.style.flexDirection);
    if(getComputedStyle(maindiv).flexDirection == "row"){
        target = "70%";
        console.log(target);
        content.style.width = target;

    }
    else if(getComputedStyle(maindiv).flexDirection == "column") {
        target = "92%";
        console.log(target);
        content.style.width = target;
